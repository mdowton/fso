...
?>
<div class="sw-woo-tab-cat style2 sw-ajax" id="<?php echo esc_attr( 'category_' . $widget_id ); ?>" >
	<div class="resp-tab" style="position:relative;">
		<div class="top-tab-slider clearfix">
			...
			<button class="navbar-toggle collapsed" type="button" data-toggle="collapse" data-target="#<?php echo esc_attr($widget_id); ?>"  aria-expanded="false">
			...
			<ul class="nav nav-tabs">
				...
				<div class="tab-content">
					...
					<div class="tab-pane active" id="<?php echo esc_attr( $category[$active]. '_' .$widget_id ) ?>">
						...
						<?php echo '<div class="view-all"><a href="' . esc_url( $viewall ) . '">' .esc_html__( 'Browse All For Her', 'sw_woocommerce' ) . '</a></div>'; ?>
					</div>
				</div>