						...
						<div class="item-detail">
							<div class="item-img">
								...
								if ( has_post_thumbnail( $post->ID ) ){
										echo get_the_post_thumbnail( $post->ID, 'topz_blog_home10' ) ? get_the_post_thumbnail( $post->ID, 'topz_blog_home10' ): '<img src="'.get_template_directory_uri().'/assets/img/placeholder/'.'large'.'.png" alt="No thumb">';		
								}else{
