				...
				<div class="product_detail">
					<div class="col-lg-6 col-md-6 col-sm-6">							
						...
						<?php 
							...
							$attachments 		= array();
						?>
							<div id="product_img_<?php echo esc_attr( $post->ID ); ?>" class="product-images loading" data-rtl="<?php echo ( is_rtl() || $topz_direction == 'rtl' )? 'true' : 'false';?>">
...
$wc_add_to_cart_variation_params = apply_filters( 'wc_add_to_cart_variation_params', array(
	'i18n_no_matching_variations_text' => esc_attr__( 'Sorry, no products matched your selection. Please choose a different combination.', 'topz' ),
) );
...
<script type="text/javascript">
 jQuery( "a.add_to_cart_button" ).attr( "title", "Add to cart" );
