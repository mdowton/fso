			...
			vc_map( array(
			  ...
			  "params" => array(
				...
				array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'default','theme1','theme2','theme3','theme4'  )
					),
				 ),	
				  array(
					"type" => "multiselect",
					...
					"dependency" => array(
						'element' => 'layout',
						'value' => array( 'default','theme1','theme2','layout2','layout3','theme3','theme4' )
					),
				 ),
				 array(
					"type" => "dropdown",
		...
		**/
		...
		function sw_category_ajax_listing(){
			...
			if( $term ) :
				...
				$thumb1 = wp_get_attachment_image( $thumbnail_id1,'topz_cat_thumb_mobile' );
