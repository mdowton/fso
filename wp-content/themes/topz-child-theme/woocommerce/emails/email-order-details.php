...
<?php if ( ! $sent_to_admin ) : ?>
	<p class="order-details-text">
		Thank you for placing this Order for your made to measure shower screen.<br />
		Attached is the PDF Drawing, implementing the dimensions that you specified. <br />
		Please carefully review the PDF and satisfy yourself that the specification you require is accurately shown.<br /><br />
		You will find 5 documents referenced in the table below. <br />
		Please review all documentation and bring to our attention any errors. <br /><br />
		Once you are satisfied, please CONFIRM ORDER near the bottom of the page.
<br />
	</p>
...
<div style="margin-bottom: 40px;">
	...
	<br />
		Once you are satisfied with all documentation, please click on the <strong>CONFIRM ORDER</strong> link below.<br />
		Upon receipt of your instructions and once the payment previously made has cleared in our bank account, the shower screen will proceed to manufacture. You will be notified once the goods have progressed to manufacture.  
	</p>
