<?php
class Topz_Options_button_set extends Topz_Options{	
	...
	*/
	function enqueue(){
		...
		wp_enqueue_style('topz-opts-jquery-ui-css');

		wp_enqueue_script(
			'topz-opts-field-button_set-js', 
			TOPZ_OPTIONS_URL.'fields/button_set/field_button_set.js', 
