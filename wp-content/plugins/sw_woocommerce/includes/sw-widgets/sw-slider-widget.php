				...
				array(
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Style 1' => 'default2', 'Layout Featured' => 'featured', 'Layout Best Sales' => 'bestsales', 'Layout Best Sales Style 1' => 'bestsales2', 'Layout Daily Deals'=>'dailydeals' ),
		...
		**/
		function WS_Shortcode( $atts, $content = null ){
			...
			elseif( $layout == 'default2' ){
				include( sw_override_check( 'sw-slider', 'default2' ) );			
			}
