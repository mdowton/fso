		...
		<div class="header-top-mobile">
				...
				<?php if ( has_nav_menu('vertical_menu') ) {?>
					<div class="vertical_megamenu">
						...
						<?php if( $fb_link != '' || $tw_link != '' || $gg_link != '' ): ?>
								<div class="topz-socials"><ul>
							<?php if( $fb_link != '' ): ?>
								<li><a href="<?php echo esc_url( $fb_link ) ?>" title="<?php echo esc_attr__( 'Facebook', 'topz' ) ?>"><i class="fa fa-facebook"></i></a></li>
							<?php endif; ?>
							
							<?php if( $tw_link != '' ): ?>
								<li><a href="<?php echo esc_url( $tw_link ) ?>" title="'<?php echo esc_attr__( 'Twitter', 'topz' ) ?>"><i class="fa fa-twitter"></i></a></li>
							<?php endif; ?>
							
							<?php if( $gg_link != '' ): ?>
								<li><a href="<?php echo esc_url( $gg_link ) ?> " title="<?php echo esc_attr__( 'Google', 'topz' ) ?>"><i class="fa fa-google-plus"></i></a></li>
							<?php endif; ?>
							</ul></div>
						<?php endif; ?>
					</div>
			...
			<div class="topz-logo">
				<a  href="<?php echo esc_url( home_url( '/' ) ); ?>">
					<?php $logo = get_template_directory_uri().'/assets/img/logo-mobile5.png'; ?>
