...
<div id="msform">
	...
	<fieldset>
		...
		<h2 class="fs-title">Click on your Shower Hinging</h2>
	...
	<fieldset class="checking">
		...
		<h2 class="fs-title">Review Your Selection</h2>
	...
	<div class="row">
		<div class="col-xs-12">
			...
			<div class="screen-dimensions-review">
				...
				<div class="door-dimensions">
					...
					<!--<div id="doorwidthreviewerror-message" style="color:red"></div>
					<div id="screenheightreviewerror-message" style="color:red"></div>
					<div id="screendepthreviewerror-message" style="color:red"></div>
					<div id="screenwidthreviewerror-message" style="color:red"></div>-->
				</div>
			</div>	
		...
		<!--<table class="details-reimg">
			<tr>
				<td>
					<div class ="reimg-descp">
						<div class="rimg-left" id="review-size-img">
							
						</div>
						<div class="rescript-right">
						    <h1>Screen Orientation</h1>
							<h2><span id ="reviewscreen-img-title"></span></h2>
							<!--<p>Chrome (Price Included) </p>-->
						<!--</div>
					</div>
				</td>
			</tr>
		...
		<table class="review-dimention">
			<tr>
				<td><div class="scr-dimn">Screen Dimentions:</div></td>
				<td><span id="review-height"></span><br><span id="review-width"></span><br><span id="review-depth"></span></td>
			</tr>
		</table>
		...
		<table class="details-reimg">
			<tr>
				<td>
					<div class ="reimg-descp">
						<div class="rimg-left" id="review-ft-finish">
							
						</div>
						<div class="rescript-right">
						    <h1>Hardware Finish</h1>
							<h2><span id ="reviewfitting-finish"></span>:</h2>
							<p><span id ="reviewfitting-finishprice"></span></p>
						</div>
					</div>
				</td>
			</tr>
		...
		<table class="details-imgright">
			<tr>
				<td>
					<div class ="reimg-descp">
						<div class="rimg-left" id="review-ft-type">
							
						</div>
						<div class="rescript-right">
						    <h1>Handle Type</h1>
							<h2><span id ="reviewfitting-type"></span>:</h2>
							<p><span id ="reviewfitting-typeprice"></span></p>
						</div>
					</div>
				</td>
			</tr>
		...
		<table class="details-reimg">
			<tr>
				<td>
					<div class ="reimg-descp">
						<div class="rimg-left" id="review-glass-type">
							
						</div>
						<div class="rescript-right">
						    <h1>Glass Type</h1>
							<h2><span id="reviewglass-type"></span>:</h2>
							<p><span id="reviewglass-typeprice"></span></p>
						</div>
					</div>
				</td>
			</tr>
		...
		<table class="details-imgright">
			<tr>
				<td>
					<div class ="reimg-descp">
						<div class="rimg-left" id="review-glass-treatment">
							
						</div>
						<div class="rescript-right">
						    <h1>Glass Treatment</h1>
							<h2><span id="reviewglass-treatment"></span>:</h2>
							<p><span id="reviewglass-treatmentprice"></span></p>
						</div>
					</div>
				</td>
			</tr>
		...
		<table class="details-imgright">
			<tr>
				<td>
					<div class ="reimg-descp">
						<div class="rimg-left" id="review-advanced-options">
							
						</div>
						<div class="rescript-right">
						    <h1>Advanced Options</h1>
							<p>1: <span id="reviewglass-topleft"></span></p>
							<p>2: <span id="reviewglass-topright"></span></p>
							<p>3: <span id="reviewglass-bottomleft"></span></p>
							<p>4: <span id="reviewglass-bottomright"></span></p>
							<p>5: <span id="reviewglass-bottomleft1"></span></p>
							<p>6: <span id="reviewglass-bottomright1"></span></p>
							<p>7: <span id="reviewglass-bottomleft2"></span></p>
							<p>8: <span id="reviewglass-bottomright2"></span></p>
						</div>
					</div>
				</td>
			</tr>
		...
		if( $cart_item['product_id'] == get_the_ID()) {
			...
			echo '<button type="submit" name="add-to-cart" value="'.get_the_ID().'" class="single_add_to_cart_button button action-button continue advanced-options product-id alt">Add to cart</button>'; 
		}
		?>
	</fieldset>
