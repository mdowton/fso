<?php
class Topz_Options_google_webfonts extends Topz_Options{	
	...
	*/
	function __construct($field = array(), $value ='', $parent){
		...
		$fonts = get_transient('topz-opts-google-webfonts');
		if(!is_array(json_decode($fonts))){
			...
			set_transient('topz-opts-google-webfonts', $fonts, 60 * 60 * 24);
