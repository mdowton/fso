			...
			foreach( $category as $cat ){
				...
				<div class="item item-product-cat">
					<div class="item-wrap">
						...
						<h4><a href="<?php echo get_term_link( $term->term_id, 'product_cat' ); ?>"><?php sw_trim_words( $term->name, $title_length ); ?></a>
						</h4>
						<a class="shop-bynow"href="<?php echo get_term_link( $term->term_id, 'product_cat' ); ?>"><?php echo esc_html__('shop by now','sw_woocommerce'); ?></a>
					</div>
				</div>
			<?php endif; ?>
			<?php } ?>
