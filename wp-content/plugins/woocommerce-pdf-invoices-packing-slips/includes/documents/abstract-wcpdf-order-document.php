...
abstract class Order_Document {
	...
	*/
	...
	public function template_custom() {
		$css1 = apply_filters( 'wpo_wcpdf_template_styles_file', $this->locate_template_file( "custom.css" ) );
		...
		$css1 = ob_get_clean();
		$css1 = apply_filters( 'wpo_wcpdf_template_styles', $css1, $this );
